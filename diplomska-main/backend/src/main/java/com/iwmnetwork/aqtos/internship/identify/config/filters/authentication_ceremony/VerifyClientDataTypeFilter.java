...
import com.iwmnetwork.aqtos.internship.identify.api.commands.registration_ceremony.VerifyClientDataTypeCommand;
...
/**
 * Verify client data type filter authentication ceremony.
 */
@AllArgsConstructor
public class VerifyClientDataTypeFilter extends UsernamePasswordAuthenticationFilter
    ...
    public void filterLogic(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        AuthenticationVerifyClientDataTypeCommand cmd = new AuthenticationVerifyClientDataTypeCommand(id);
