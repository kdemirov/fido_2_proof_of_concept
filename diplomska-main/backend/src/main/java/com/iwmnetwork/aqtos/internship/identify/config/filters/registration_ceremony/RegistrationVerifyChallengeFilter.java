...
import com.iwmnetwork.aqtos.internship.identify.api.commands.registration_ceremony.RegistrationVerifyChallengeCommand;
...
/**
 * Verify challenge for registration ceremony filter.
 */
@RequiredArgsConstructor
@Component
@Order(Constants.FORTH_FILTER_REGISTRATION_CEREMONY)
public class RegistrationVerifyChallengeFilter extends OncePerRequestFilter
    ...
    public void filterLogic(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        RegistrationVerifyChallengeCommand cmd = new RegistrationVerifyChallengeCommand(registrationCeremonyId);
