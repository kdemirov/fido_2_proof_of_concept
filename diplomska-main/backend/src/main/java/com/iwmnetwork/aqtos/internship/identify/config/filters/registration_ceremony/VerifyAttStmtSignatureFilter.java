...
import com.iwmnetwork.aqtos.internship.identify.api.commands.registration_ceremony.VerifyAttStmtSignatureCommand;
...
/**
 * Verify Attestation Statement signature filter.
 */
@Component
...
public class VerifyAttStmtSignatureFilter extends OncePerRequestFilter
    ...
    public void filterLogic(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        VerifyAttStmtSignatureCommand cmd = new VerifyAttStmtSignatureCommand(registrationCeremonyId);
