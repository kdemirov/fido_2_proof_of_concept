...
import com.iwmnetwork.aqtos.identify.demo.api.commands.FidoUserRegistrationFinishCommand;
...
import com.iwmnetwork.aqtos.identify.demo.repository.RelyingPartyJpaRepository;
import com.iwmnetwork.aqtos.identify.demo.repository.webauthn.authenticator_model.*;
import com.iwmnetwork.aqtos.identify.demo.repository.webauthn.crypto.CBORDecoder;
import com.iwmnetwork.aqtos.identify.demo.repository.webauthn.crypto.JsonParser;
import com.iwmnetwork.aqtos.identify.demo.repository.webauthn.crypto.RelyingPartyVerifying;
...
public class RelyingPartyService {
    ...
    private final RelyingPartyJpaRepository repository;
    ...
    public RelyingPartyService(CommandGateway commandGateway,
                               RelyingPartyJpaRepository repository,
     ...
     */
    public boolean decodeAndVerifyResponseObject(FidoUserRegistrationStartCommand cmd)
        ...
        if (RelyingPartyVerifying.verify(response,
            ...
            this.commandGateway.send(new FidoUserRegistrationFinishCommand(user.getId(),
                    user.getName(),
                    cmd.getUsername(),
     ...
     * @throws Fido2Exception
     */
    public boolean decodeAndVerifyAssertionObject(FidoUserAuthenticateCommand command)
            throws JSONException, Fido2Exception {
        RelyingPartyVerifying.setEnvironment(this.environment);
    ...
    public String createChallenge() {
        ...
        this.repository.save(new RelyingParty(challenge));
        return challenge;
    }
}
