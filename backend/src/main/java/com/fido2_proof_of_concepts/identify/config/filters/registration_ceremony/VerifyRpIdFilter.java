...
import com.fido2_proof_of_concepts.identify.api.commands.registration_ceremony.VerifyRpIdCommand;
...
public class VerifyRpIdFilter extends OncePerRequestFilter
    ...
    public void filterLogic(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        VerifyRpIdCommand command = new VerifyRpIdCommand(registrationCeremonyId);
