...
import com.iwmnetwork.aqtos.internship.identify.api.commands.registration_ceremony.VerifyAlgParameterInAuthDataCommand;
...
/**
 * Verify alg type parameter in auth data filter.
 */
@Component
@RequiredArgsConstructor
@Order(Constants.ELEVENTH_FILTER_REGISTRATION_CEREMONY)
public class VerifyAlgParameterInAuthDataFilter extends OncePerRequestFilter
    ...
    public void filterLogic(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        VerifyAlgParameterInAuthDataCommand cmd = new VerifyAlgParameterInAuthDataCommand(
