...
import com.fido2_proof_of_concepts.identify.api.commands.registration_ceremony.VerifyChallengeCommand;
...
public class VerifyChallengeFilter extends OncePerRequestFilter
    ...
    public void filterLogic(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        VerifyChallengeCommand cmd = new VerifyChallengeCommand(registrationCeremonyId);
